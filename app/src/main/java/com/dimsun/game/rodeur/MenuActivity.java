...
public class MenuActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        classe = sharedP.getInt(String.valueOf(Constantes.KEY_CLASSE),0);
        hasSound = sharedSettingsPref.getBoolean(String.valueOf(Constantes.KEY_HAS_SOUND), false);
        ...
        continuer.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                toggleSound();
                Log.i(TAG, "Continuer");
                startActivity(new Intent(MenuActivity.this, MarcheActivity.class));
            }
        });
        ...
        nouveau.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                toggleSound();
                Log.i(TAG, "Nouveau");
                startActivity(new Intent(MenuActivity.this, NouveauPersonnageActivity.class));
            }
        });
        ...
        aPropos.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                toggleSound();
                Log.i(TAG, "A Propos");
                Uri uriUrl = Uri.parse(Constantes.WIKI_URL);
