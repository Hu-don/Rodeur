...
public class activity_marche extends Activity implements SensorEventListener {

    final String TAG = activity_marche.class.getSimpleName( );
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        dataStep = getSharedPref.getInt("KEY_STEP", 0);
        dataVie = getSharedPref.getInt("KEY_VIE", 0);
        dataPoint = getSharedPref.getInt("KEY_POINT", 0);
        dataNext = getSharedPref.getInt("KEY_NEXT", 0);
        dataVieMax = getSharedPref.getInt("KEY_VIE_MAX", 0);
        dataCharDesign = getSharedPref.getInt("KEY_CLASSE", 0);
        ...
        buttonToStats.setOnClickListener(new View.OnClickListener( ) {
            ...
            public void onClick(View v) {
                toggleSound( );
                startActivity(new Intent(activity_marche.this, CharActivity.class));
                finish( );
            }
        });
    }
    ...
    public void rencontreListener() {
        ...
        switch (randomMeetNum2) {
            ...
            case 10:
                ...
                i(TAG, "•••••••••••••••• MEET •••••••••••••••••");
                i(TAG, "•••••••••••••••• COMBAT •••••••••••••••••");
                startActivity(new Intent(this, ChoiceCombat_Activity.class));
                finish( );
                break;
        }
    }
    ...
    private void savedNiveauToSharedPref(int dataNiv) {
        ...
        sharedPref = getApplicationContext( ).getSharedPreferences(PREFS_NAME, Context.MODE_PRIVATE);
        editor = sharedPref.edit( );
        editor.putInt("KEY_NIVEAU", dataNiv);
