...
public class NouveauPersonnageActivity extends Activity {
    ...
    String joueur_nom= "";
    Context ctx = this;
    final String TAG = NouveauPersonnageActivity.class.getSimpleName();
        ...
        validerCreation.setOnClickListener(new View.OnClickListener( ) {
            ...
            public void onClick(View view) {
                ...
                if (joueur_nom.isEmpty()){
                    ...
                    startActivity(new Intent(NouveauPersonnageActivity.this, MarcheActivity.class));
                }
            }
        });
    }
    ...
    private void save (String nom, int classe, int vie, int defense, int force, int esquive, int magie, int chance) {
        ...
        editor.putString(Constantes.KEY_NOM, nom);
        editor.putInt(Constantes.KEY_CLASSE, classe);
        editor.putInt(Constantes.KEY_NIVEAU, 1);
        editor.putInt(Constantes.KEY_VIE, vie);
        editor.putInt(Constantes.KEY_VIE_MAX, vie);
        editor.putInt(Constantes.KEY_CHANCE, chance);
        editor.putInt(Constantes.KEY_ESQUIVE, esquive);
        editor.putInt(Constantes.KEY_MAGIE, magie);
        editor.putInt(Constantes.KEY_DEFENSE, defense);
        editor.putInt(Constantes.KEY_FORCE, force);
        editor.putInt(Constantes.KEY_STEP, step);
        editor.putInt(Constantes.KEY_POINT, point);
        editor.putInt(Constantes.KEY_OR, 10);
        editor.apply();
